...
const INTENSITY_SCALE = [
    { color: '#ccff00', label: 'Very high', sub: '>80%' },
    { color: '#66ff00', label: 'High', sub: '60–80%' },
    { color: '#00cc44', label: 'Medium', sub: '40–60%' },
    { color: '#00ff88', label: 'Low', sub: '20–40%' },
    { color: '#003311', label: 'Very low', sub: '<20%' },
]

export function HeatmapTab({ data, report }: HeatmapTabProps) {
    const hasImage = report.thumbnailUrl?.startsWith('data:') || report.thumbnailUrl?.startsWith('blob:')

    return (
        <div className="p-6 space-y-6">

            {/* ── Key insight — subtle, not dominant ── */}
            ...
            <div className="space-y-3">
                ...
                {hasImage ? (
                    <div className="relative w-full overflow-hidden rounded-xl border">
                        {/* Invisible img sets natural height */}
